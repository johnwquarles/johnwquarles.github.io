...
angular.module('app.factories').factory('Links', function () {
  return [{ img: 'movieagenda.png',
    ...
    copy: 'Can\'t remember which films to catch? Make your own list             with MovieAgenda and have Metacritic & Rotten Tomato scores,             MPAA ratings, trailers and assorted clips all at your fingertips.' }, { img: 'blackjack.png',
    link_url: 'http://quarl.es/blackjack',
    alt: 'Blackjack',
    github_url: 'https://github.com/johnwquarles/blackjack',
    tech: 'Tech: Javascript, JQuery, HTML5, Sass',
    copy: 'Need a hit? Play a few hands of no-stakes Blackjack             and keep your bank account intact.' }, { img: 'weather-app.png',
    link_url: 'http://quarl.es/weather-app',
    alt: 'Weather App',
    github_url: 'https://github.com/johnwquarles/weather-app',
    tech: 'Tech: Javascript, HTML5, CSS',
    copy: 'No need to feel embarrassed-- we all forget to check             the weather sometimes. Quick, before anyone finds out!             Get your forecast by zip code or geolocation!             And for goodness\' sake, check the five-day!' }, { img: 'stocksbocks.png',
    ...
    copy: 'If you\'re serious about business, you know stocks             and you know bocks. So prepare to have your socks rocked, doc!             Presenting STOCKSBOCKS.' }, { img: 'armolegeddon.png',
    link_url: 'http://quarl.es/armolegeddon',
    alt: 'Armolegeddon',
    github_url: 'https://github.com/johnwquarles/armolegeddon/tree/gh-pages',
    tech: 'Tech: Javascript, HTML5, CSS',
    copy: 'Moles! Holes! See if you can bop more of them than I can setTimeouts.             Thinking about it though, no, that\'s definitely impossible.' }, { img: 'sketchy-etch.png',
